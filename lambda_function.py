"""
Urban Dictionary Word of the Day Presented by Amazon's Alexa/Echo
Developer: Nikush Dalia (nikushx)
With help from Andrew Dalia
"""
...
# --------------- Function that gets the word of the day and definition --------
...
def get_welcome_response():
    ...
    word, wordDef = get_wotd()

    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the Urban Dictionary Word of the Day. " \
